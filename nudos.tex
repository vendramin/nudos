...
%---------------------
\title{Nudos, quandles y homolog\'ia}
\author{Leandro Vendramin} % o \author{Un Autor y Otro Autor}, etc.
% \shorttitle{....} % <--- No tiene ning\'un efecto si hay \supertitle
%---------------------

%---------------------
\contact{Leandro Vendramin, Department of Mathematics, Vrije Universiteit Brussel, Pleinlaan 2, 1050 Brussel, Belgium}
{Leandro.Vendramin@vub.be}{https://vendramin.github.io}
...
\begin{wrapfigure}{r}{0.2\textwidth}
	\centering
	\includegraphics[scale=0.5]{images/rope}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\includegraphics[scale=0.5]{images/real}
    \caption{Nudos.}
    \label{fig:nudo}
\end{wrapfigure}
...
\begin{figure}[h]
	\centering
    \includegraphics[scale=0.2]{images/reidemeister}
...
\begin{wrapfigure}{r}{3cm}
	\centering
	\includegraphics[scale=0.5]{images/wild}
...
\end{wrapfigure}
	...
	\begin{figure}[ht]
        \centering
    	\includegraphics[scale=0.5]{images/wrongcrossings}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
    	\includegraphics[scale=0.5]{images/unknots}
        \caption{Tres proyecciones del nudo trivial.}
        \label{fig:trivial}
	\end{minipage}
	\begin{minipage}{0.45\textwidth}
    	\centering
		\includegraphics[scale=0.5]{images/thistlethwaite}
    ...
    \index{Reidemeister!movimientos de}
		...
		\begin{figure}[ht]
			...
			\begin{minipage}{0.3\textwidth}
				\centering
				\includegraphics[width=0.5\textwidth]{images/reidemeisterI}
				\caption{$\mathcal{R}_1$}
				\label{fig:reidemeister1}
			\end{minipage}
			\begin{minipage}{0.3\textwidth}
				\centering
				\includegraphics[width=0.5\textwidth]{images/reidemeisterII}
				\caption{$\mathcal{R}_2$}
				\label{fig:reidemeister2}
			\end{minipage}
			\begin{minipage}{0.3\textwidth}
				\centering
				\includegraphics[width=0.5\textwidth]{images/reidemeisterIII}
...
\begin{example}
	\begin{figure}[ht]
		...
		\centering
		\includegraphics[scale=0.5]{images/trefoils}
		\caption{Dos proyecciones del nudo $3_1$.}
		\label{fig:trefoil}
	\end{minipage}
	\begin{minipage}{0.4\textwidth}
		\centering
		\includegraphics[scale=0.5]{images/4_1unoriented}
		\caption{El nudo $4_1$.}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{images/knots}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/grannyandsquare}
...
\begin{figure}[ht]
	\centering
    \includegraphics[scale=0.2]{images/fox}
...
resultado es un caso particular del teorema~\ref{thm:fox} que veremos más
adelante. 
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{images/crossing}
...
\begin{thm}
    ...
    \begin{proof}
		...
		pues, como $d=2a-(2b-c)$ y $d'=2(2a-b)-(2a-c)$, se tiene que $d=d'$. 
		\begin{figure}[ht]
			\centering
...
\end{defn}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.2]{images/wirtinger}
...
\end{xca}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.2]{images/dehn}
...
\begin{figure}[ht]
	\centering
    \includegraphics[scale=0.2]{images/tietze}
...
sets}. 
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.3]{images/cwjb}
...
\begin{example}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.2]{images/alexander}
...
\end{example}
	...
	teorema~\ref{thm:fox}. La diferencia está en que ahora habrá más diagramas
	...
	\begin{minipage}{0.5\textwidth}
		\centering
        \includegraphics[scale=0.5]{images/oriented_R2}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.5]{images/oriented_R3a}
...
\section{Ejemplos de quandle fundamentales}
	...
	\begin{figure}[ht]
		...
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.5]{images/5_1}
			\caption{$5_1$}
			\label{fig:5_1}
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.5]{images/5_2}
			\caption{$5_2$}
			\label{fig:5_2}
		\end{minipage}
	\end{figure}
...
\begin{figure}[ht]
		...
		\begin{minipage}{0.3\textwidth}
			\centering
		    \includegraphics[scale=0.5]{images/6_1}
			\caption{$6_1$}
			\label{fig:6_1}
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\centering
		    \includegraphics[scale=0.5]{images/6_2}
			\caption{$6_2$}
			\label{fig:6_2}
		\end{minipage}
		\begin{minipage}{0.3\textwidth}
			\centering
		    \includegraphics[scale=0.5]{images/6_3}
			\caption{$6_3$}
			\label{fig:6_3}
		\end{minipage}
	\end{figure}
	...
	\begin{figure}[ht]
		...
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.5]{images/7_1}
			\caption{$7_1$}
			\label{fig:7_1}
		...
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.5]{images/7_2}
			\caption{$7_2$}
			\label{fig:7_2}
		...
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.5]{images/7_3}
			\caption{$7_3$}
			\label{fig:7_3}
		\end{minipage}
	\end{figure}
...
\begin{figure}[ht]
		...
		\begin{minipage}{0.2\textwidth}
			\centering
	    	\includegraphics[scale=0.5]{images/7_4}
			\caption{$7_4$}
			\label{fig:7_4}
		\end{minipage}
		\begin{minipage}{0.2\textwidth}
			\centering
	    	\includegraphics[scale=0.5]{images/7_5}
			\caption{$7_5$}
			\label{fig:7_5}
		\end{minipage}
		\begin{minipage}{0.2\textwidth}
			\centering
	    	\includegraphics[scale=0.5]{images/7_6}
			\caption{$7_6$}
			\label{fig:7_6}
		\end{minipage}
		\begin{minipage}{0.2\textwidth}
			\centering
	    	\includegraphics[scale=0.5]{images/7_7}
			\caption{$7_7$}
			\label{fig:7_7}
		\end{minipage}
	\end{figure}
	...
	\begin{figure}[ht]
		...
		\begin{minipage}{0.3\textwidth}
			\centering
			\includegraphics[scale=0.55]{images/3_1m}
...
\label{section:coloreos_generalizados}
    ...
    \begin{figure}[h]
		\centering
	    \includegraphics[scale=0.5]{images/quandlecrossing}
...
\begin{xca}
    Utilice los resultados de los ejercicios \ref{xca:colorings},
    \ref{xca:varios_pares} y \ref{xca:5_2y7_1} y demuestre que todos los nudos
...
\begin{example}
	...
	ejercicio~\ref{xca:granny_and_square} vimos que estos nudos tienen grupos
	...
	\end{equation}
	Vimos en el ejercicio~\ref{xca:granny_and_square} que el nudo de la abuela

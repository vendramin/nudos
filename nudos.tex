...
\end{proof}
		...
		\begin{figure}[ht]
			...
			\begin{minipage}{0.3\textwidth}
				\centering
				\includegraphics[width=0.6\textwidth]{images/reidemeisterIII}
...
\begin{figure}[ht]
	\centering
    \includegraphics[scale=0.4]{images/fox}
...
\end{definition}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.3]{images/wirtinger}
...
\end{exercise}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.3]{images/dehn}
...
\begin{figure}[ht]
	\centering
    \includegraphics[scale=0.3]{images/tietze}
...
\begin{example}
    ...
    \begin{figure}[h]
		\centering
        \includegraphics[scale=0.3]{images/alexander}
